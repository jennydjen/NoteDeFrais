...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'jenny_user.registration.form.type' => 'getJennyUser_Registration_Form_TypeService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Jenny\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Jenny\\ImportBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Jenny\\UserBundle\\Entity');
        $c->addDriver($b, 'Jenny\\ImportBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('JennyUserBundle' => 'Jenny\\UserBundle\\Entity', 'JennyImportBundle' => 'Jenny\\ImportBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_859e53ad3d1723159dc8845a78377ac860b5c6bc4859cfd02c8fa7a97e19f52c');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Jenny\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Jenny\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'jenny_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Jenny\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Jenny\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Jenny\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'jenny_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jenny\UserBundle\Form\Type\RegistrationFormType A Jenny\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getJennyUser_Registration_Form_TypeService()
    {
        return $this->services['jenny_user.registration.form.type'] = new \Jenny\UserBundle\Form\Type\RegistrationFormType();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Jenny\\UserBundle/Resources/views'), 'JennyUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Jenny\\ImportBundle/Resources/views'), 'JennyImport');
        $instance->addPath(($this->targetDirs[3].'\\src\\Jenny\\StatBundle/Resources/views'), 'JennyStat');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'JennyUserBundle' => 'Jenny\\UserBundle\\JennyUserBundle',
                'JennyImportBundle' => 'Jenny\\ImportBundle\\JennyImportBundle',
                'JennyStatBundle' => 'Jenny\\StatBundle\\JennyStatBundle',
            ...
            'fos_user.model.user.class' => 'Jenny\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'jenny_user_registration',
